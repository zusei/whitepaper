...
* **Action:** Merchant purchases $ZUSEI on the open market (CEX/DEX).
* **Conversion:** Merchant sends $ZUSEI to the **Burn Address** via the Zusei Merchant Dashboard.
...
Where:
* $B_t$: The number of $ZUSEI tokens burned at time $t$.
* $U_t$: The Usage Demand (Total USD value of $Z-WATT credits requested by the merchant).
* $P_t$: The Market Price of 1 $ZUSEI token in USD.

> **Example:** A Merchant needs **$100 worth of Credits** (approx 1,000 Watts).
> * **Scenario A:** If $ZUSEI = $1.00, they must burn **100 Tokens**.
> * **Scenario B:** If $ZUSEI = $10.00, they only burn **10 Tokens**.
...
1.  **Merchant** buys $ZUSEI on Exchange (Creating **Demand**).
2.  **Merchant** burns $ZUSEI -> Protocol (Creating **Scarcity**).
